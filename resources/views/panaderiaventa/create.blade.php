...
@section('content_header')
    <h1>SALIDA DE PAN O POSTRE</h1>
@stop

@section('content')
<form action="/panaderiaventas" method="POST">
    @csrf
    <!-- <div class="mb-3">
    ...
    <div>
            <div class="col-12 mb-3">
                ...
                @foreach($panaderiaingreso as $panaderiaingreso)

                <option value="{{$panaderiaingreso->id}}">{{$panaderiaingreso->tipo}}</option>
